...
Pick a **mode** below. **Install the CLI** from **[kzero releases](https://github.com/hrodrig/kzero/releases)** (**[v1.1.1](https://github.com/hrodrig/kzero/releases/tag/v1.1.1)** recommended). **This** repo holds operator docs and examples only.
...
Use a published image tag that matches your desired [kzero](https://github.com/hrodrig/kzero) release (in-cluster examples pin **`v1.1.1`**).
