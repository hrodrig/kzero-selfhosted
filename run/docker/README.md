...
Examples use **`v0.5.3`**; pick a tag that exists on GHCR ([kzero releases](https://github.com/hrodrig/kzero/releases)).
...
```bash
docker run --rm ghcr.io/hrodrig/kzero:v0.5.3 version
```
