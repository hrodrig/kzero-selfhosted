...
Examples use **`v1.1.1`**; pick a tag that exists on GHCR ([kzero releases](https://github.com/hrodrig/kzero/releases)).
...
```bash
docker run --rm ghcr.io/hrodrig/kzero:v1.1.1 version
```
