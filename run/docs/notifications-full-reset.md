...
How to exercise **Slack** notifications with **[kzero v1.1.0](https://github.com/hrodrig/kzero/releases/tag/v1.1.0)** and the **full-reset-example** profile (namespace **`kzero-demo`** on a lab cluster).
...
Fields typically include **Cluster**, **Client**, **Context**, **User**, **Mode**, **Duration**. Footer: **`kzero v1.1.0`** (or your installed version). Watchdog trips use title **`kzero stalled`** (**`pipeline.stalled`** event).
