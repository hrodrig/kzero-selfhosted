...
| Requirement | Notes |
|-------------|--------|
| **kzero image** | **`ghcr.io/hrodrig/kzero:v1.1.1`** with **InClusterConfig** fallback when **`run.kubeconfig`** is empty ([kzero v0.8.0+](https://github.com/hrodrig/kzero/releases/tag/v0.8.0)). |
